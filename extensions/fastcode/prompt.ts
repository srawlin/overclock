...
- Use the explore sub-agent for questions spanning more than ~2 files; use delegate for bounded, verifiable tasks; use verify as an independent check on work you did not write. Sub-agent file contents never enter your context.
